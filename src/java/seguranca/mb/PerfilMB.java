...
public class PerfilMB {
    ...
    public void novo() {
        ...
        tbPerfil.setDtaPerfilCad(data);
        tbPerfil.setUsrPerfilCad(usuario);
        incluirNovo = true;
    }

    public void salvar() {
        if (incluirNovo == false) {
            tbPerfil.setDtaPerfilMod(data);
            tbPerfil.setUsrPerfilMod(usuario);
        }
    ...
    public void salvarProc() {
        ...
        for (Object item : opcoes.getTarget()) {
            ...
            taPrivilegio.setDtaPrivilegioCad(data);
            taPrivilegio.setUsrPrivilegioCad(usuario);
